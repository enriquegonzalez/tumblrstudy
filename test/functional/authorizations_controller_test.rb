...
class AuthorizationsControllerTest < ActionController::TestCase
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post :create, authorization: { provider: @authorization.provider, secret: @authorization.secret, token: @authorization.token, uid: @authorization.uid }
    end
  ...
  test "should update authorization" do
    put :update, id: @authorization, authorization: { provider: @authorization.provider, secret: @authorization.secret, token: @authorization.token, uid: @authorization.uid }
    assert_redirected_to authorization_path(assigns(:authorization))
  end
